...
add_action('admin_init', 'book_junky_meta_testimonials');

MetaFramework::init();

function book_junky_meta_testimonials()
{

    /** page options */
    MetaFramework::setMetabox(array(
        'id' => '_testimonials_options',
        'label'=> esc_html__('Wrap Info', 'book-junky'),
        ...
        'sections' => array(
            array(
                'title' => esc_html__('More Info', 'book-junky'),
                'fields' => array(
                    array(
			            'id'                => 'location',
			            'type'              => 'text',
			            'title'             => esc_html__( 'Location', 'book-junky' ),
			        ),
                )
            ),
        )
