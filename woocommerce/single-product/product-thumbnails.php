...
if ( $attachment_ids ) {
	...
	<?php
		foreach ( $attachment_ids as $attachment_id ) {
			...
			$html  = '<a data-lightbox="light-box" href="' . esc_url( $full_size_image[0] ) . '">';
			$html .= wp_get_attachment_image( $attachment_id, 'book_junky_230X300', false, $attributes );
	 		$html .= '</a>';
	...
	echo "<p>" . esc_html__('Gallery Empty !','book-junky') . "</p>";
}
